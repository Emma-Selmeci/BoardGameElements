/**
 * Shows shortest possible path between two nodes of a graph
 * This class can clearly be improved but it is not necessary yet, as this is a rarely used class
 */
...
public class SimpleGraphRouter {
    ...
    public SimpleGraphRouter(int numberOfNodes) {
